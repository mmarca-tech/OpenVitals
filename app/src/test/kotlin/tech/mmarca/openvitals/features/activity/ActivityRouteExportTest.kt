...
class ActivityRouteExportTest {
     ...
     * `writeActivityRouteGpx` makes; the assertions are about the document that
     * comes out, so the structure under test is the exporter's, not this.
     */
    private fun recordingXmlSerializer(): XmlSerializer {
