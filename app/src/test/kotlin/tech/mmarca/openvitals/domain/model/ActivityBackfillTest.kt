...
class ActivityBackfillTest {
        ...
        val workout = workout(
            ...
            route = ExerciseRouteData(
                ...
                points = listOf(
                    ...
                    routePoint(seconds = 60, latitude = 0.0, longitude = 0.01, altitudeMeters = 40.0),
                    routePoint(seconds = 120, latitude = 0.01, longitude = 0.01, altitudeMeters = 35.0),
                    routePoint(seconds = 180, latitude = 0.01, longitude = 0.02, altitudeMeters = 80.0),
                ),
            ),
        )
    ...
    fun `sample backfill integrates a distance from speed when none was written`() {
        ...
        val result = workout.withSampleBackfilledMetrics(
            ...
            speedSamples = (0..600).map { second ->
                SpeedSample(
                    time = Instant.EPOCH.plusSeconds(second.toLong()),
                    metersPerSecond = 2.0,
                    source = "watch",
                )
            },
        ...
        assertEquals(1_200.0, result.totalDistanceMeters ?: 0.0, 1.0)
    }

    @Test
    fun `a recorded distance beats one integrated from speed`() {
        val workout = workout(totalDistanceMeters = 1_000.0)
        ...
        assertEquals(1_000.0, result.totalDistanceMeters ?: 0.0, 0.001)
    }
    ...
    fun `route backfill replaces empty zero summaries with route values`() {
        val workout = workout(
            ...
            route = ExerciseRouteData(
                ...
                points = listOf(
                    routePoint(seconds = 0, latitude = 0.0, longitude = 0.0, altitudeMeters = 10.0),
                    routePoint(seconds = 60, latitude = 0.0, longitude = 0.01, altitudeMeters = 90.0),
                ),
            ),
        )
        ...
        assertEquals(80.0, result.elevationGainedMeters ?: 0.0, 0.001)
    }
