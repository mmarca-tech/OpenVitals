...
fun TimeRangeSelector(
    selected: dev.manu.hcdashboard.data.model.TimeRange,
    onSelect: (dev.manu.hcdashboard.data.model.TimeRange) -> Unit,
    modifier: Modifier = Modifier,
) {
    Row(
        modifier = modifier
        ...
        dev.manu.hcdashboard.data.model.TimeRange.entries.forEach { range ->
