...
internal fun MetricRouteContent(
    ...
    pinnedDay: java.time.LocalDate? = null,
    ...
    when (val destination = metricRouteDestinationFor(metricId)) {
        ...
        MetricRouteDestination.BodyEnergy -> {
            ...
            // The readiness verdict is a card on this screen now.
            ...
            BodyEnergyDetailsScreen(
                ...
                selectedDate = pinnedDay ?: LocalDate.now(),
...
internal sealed interface MetricRouteDestination {
    ...
    data object Activities : MetricRouteDestination
    data object Sleep : MetricRouteDestination
    data object BodyEnergy : MetricRouteDestination
    data object Hydration : MetricRouteDestination
    data object Caffeine : MetricRouteDestination
    data object Mindfulness : MetricRouteDestination
    data object Cycle : MetricRouteDestination
    data object CardioLoad : MetricRouteDestination
    data object Unknown : MetricRouteDestination
}

internal fun metricRouteDestinationFor(metricId: DashboardWidgetId?): MetricRouteDestination {
    if (metricId == null) return MetricRouteDestination.Unknown
    if (metricId.isCaloriesDetailMetric()) return MetricRouteDestination.Calories
    ...
    return when (metricId) {
        DashboardWidgetId.WORKOUT -> MetricRouteDestination.Activities
        DashboardWidgetId.SLEEP -> MetricRouteDestination.Sleep
        DashboardWidgetId.BODY_ENERGY -> MetricRouteDestination.BodyEnergy
        DashboardWidgetId.HYDRATION -> MetricRouteDestination.Hydration
        DashboardWidgetId.CAFFEINE -> MetricRouteDestination.Caffeine
        DashboardWidgetId.MINDFULNESS -> MetricRouteDestination.Mindfulness
        DashboardWidgetId.CYCLE -> MetricRouteDestination.Cycle
        DashboardWidgetId.WEEKLY_CARDIO_LOAD,
        DashboardWidgetId.CARDIO_LOAD -> MetricRouteDestination.CardioLoad
        else -> MetricRouteDestination.Unknown
    }
}
...
internal fun dashboardTileDestination(
    ...
    DashboardWidgetId.BMR -> Screen.Calories.route.withSelectedDay(selectedDate)
