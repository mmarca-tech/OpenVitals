...
object CaffeineInsightCalculator {
    ...
    fun build(
        ...
        return CaffeineInsights(
            ...
            safeNights = dailyStats.count { it.nightCompleted && it.safeForSleep },
            totalNights = dailyStats.count { it.nightCompleted },
    ...
    private fun bedtimeInstant(date: LocalDate, bedtime: LocalTime, zone: ZoneId): Instant {
        ...
        return onDate.atTime(bedtime).atZone(zone).toInstant()
    }
