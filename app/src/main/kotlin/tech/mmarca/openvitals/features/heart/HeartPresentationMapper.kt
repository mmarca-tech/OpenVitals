...
object HeartPresentationMapper {
    ...
    fun applyLoadResult(
        ...
        return current.copy(
            ...
            bloodPressureDaily = result.bloodPressureDaily,
            spO2Daily = result.spO2Daily,
            respiratoryRateDaily = result.respiratoryRateDaily,
            bodyTemperatureDaily = result.bodyTemperatureDaily,
            vo2MaxDaily = result.vo2MaxDaily,
            bloodGlucoseDaily = result.bloodGlucoseDaily,
            skinTemperatureDaily = result.skinTemperatureDaily,
            timedOutVitals = result.timedOutVitals,
