...
object DashboardPresentationMapper {
    ...
    fun build(
        ...
        return DashboardDisplayState(widgets = widgets, unsupportedIds = unsupportedIds)
    }
    ...
    private fun buildWidget(
        ...
        DashboardWidgetId.SLEEP -> optionalMetricWidget(
            ...
            progress = data.sleep?.let {
                goalProgressModel(
                    current = it.asleepDurationMs().toDouble(),
        ...
        DashboardWidgetId.BODY_ENERGY -> optionalMetricWidget(
            ...
            bodyEnergySubtitle = data.bodyEnergyTimeline
                ?.takeIf { bodyEnergySetupCompleted }
                ?.let { timeline ->
                    BodyEnergyTileSubtitle(
        ...
        DashboardWidgetId.CAFFEINE -> optionalMetricWidget(
            ...
            caffeineConsumedTodayMg = data.activeCaffeineMg
                ?.let { data.caffeineGrams?.let { grams -> (grams * 1000.0).roundToLong() } },
            isLoading = isLoading,
        )
    ...
    private fun optionalMetricWidget(
        ...
        caffeineConsumedTodayMg: Long? = null,
        bodyEnergySubtitle: BodyEnergyTileSubtitle? = null,
        ...
        DashboardWidgetDisplayModel(
            ...
            caffeineConsumedTodayMg = caffeineConsumedTodayMg,
            bodyEnergySubtitle = bodyEnergySubtitle,
            showTitle = showTitle,
