...
internal fun MutablePreferences.putQuickBeverageSnapshot(snapshot: HomeQuickBeverageSnapshot) {
    ...
    this[HomeQuickBeverageWidgetState.amountKey] = snapshot.amount
    this[HomeQuickBeverageWidgetState.subtitleKey] = snapshot.subtitle
    this[HomeQuickBeverageWidgetState.routeKey] = snapshot.route
}
...
internal fun quickBeverageAmountLabel(
...
internal fun isQuickBeverageOneTapWidget(context: Context, appWidgetId: Int): Boolean =
