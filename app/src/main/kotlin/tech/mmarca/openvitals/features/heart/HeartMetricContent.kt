    ...
    if (onOpenHeartRateRecovery != null) {
        item {
            HeartRateRecoveryEntryCard(
                onOpen = onOpenHeartRateRecovery,
...
@Composable
private fun HeartRateRecoveryEntryCard(
    onOpen: () -> Unit,
    ...
    OpenVitalsCard(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                Text(
                    text = stringResource(R.string.heart_rate_recovery_history_title),
                    style = MaterialTheme.typography.titleSmall,
                    color = MaterialTheme.colorScheme.onSurface,
                )
                Text(
                    text = stringResource(R.string.heart_rate_recovery_trend_title),
