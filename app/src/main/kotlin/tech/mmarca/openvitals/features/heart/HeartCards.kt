...
internal fun heartRateTimelineStats(samples: List<HeartRateSample>): HeartRateTimelineStats {
...
internal fun HeartRateTimelineCard(
    ...
    val avgBpm = stats.avgBpm
    val paddedMin = stats.paddedMin
    val paddedMax = stats.paddedMax
    ...
    OpenVitalsCard(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            DayTimelineLinePlot(
                ...
                title = stringResource(R.string.screen_heart_rate),
