...
@Composable
internal fun StressDetailsContent(
        ...
        LazyColumn(
            ...
            item {
                StressListCard(
                    ...
                    items = stressFactorLines(stress).ifEmpty {
            ...
            item {
                StressListCard(
                    ...
                    items = stressCoverageLines(stress).ifEmpty {
            ...
            item {
                StressListCard(
                    ...
                    items = stressCaveatLines(stress),
                    modifier = Modifier.padding(horizontal = 16.dp),
                )
            }
            item {
...
private fun StressScoreCard(
    ...
    OpenVitalsCard(
        ...
        Column(
            ...
            Text(
                text = stringResource(stressLevelLabelRes(stress.level)),
                style = MaterialTheme.typography.headlineSmall,
                fontWeight = FontWeight.SemiBold,
                color = accent,
            )
            Text(
                text = stringResource(stressLevelDetailRes(stress.level)),
