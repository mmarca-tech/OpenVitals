...
data class AchievementsUiState(
    ...
    /** The chip filter: "All" is the whole list; a chip is exactly its category's badges. */
    fun badgesFor(category: AchievementCategory?): List<AchievementProgress> =
        if (category == null) badges else badges.filter { it.definition.category == category }
}
