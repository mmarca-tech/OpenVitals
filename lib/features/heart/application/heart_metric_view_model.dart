...
class HeartMetricViewModel extends Notifier<HeartMetricState>
    with PeriodMetricLoader<HeartMetricState, HeartPeriodLoadResult> {
  ...
  @override
  PeriodSelection selectionOf(HeartMetricState state) =>
      PeriodSelection(state.selectedRange, state.selectedDate);

  @override
  HeartMetricState onLoadStart(
  ...
  @override
  HeartMetricState onLoadSuccess(
    HeartMetricState state,
  ...
  @override
  HeartMetricState onLoadError(HeartMetricState state, ScreenError error) =>
