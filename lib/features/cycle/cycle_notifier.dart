...
part 'cycle_notifier.freezed.dart';
...
class CycleNotifier extends Notifier<CycleMetricState> {
  int _generation = 0;
...
final cycleProvider = NotifierProvider<CycleNotifier, CycleMetricState>(
  CycleNotifier.new,
);
