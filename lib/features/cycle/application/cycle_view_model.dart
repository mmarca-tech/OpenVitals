...
class CycleViewModel extends Notifier<CycleMetricState>
    with PeriodMetricLoader<CycleMetricState, CyclePeriodData> {
  @override
  ...
  @override
  PeriodSelection selectionOf(CycleMetricState state) =>
      PeriodSelection(state.selectedRange, state.selectedDate);

  @override
  CycleMetricState onLoadStart(
  ...
  @override
  Future<Result<CyclePeriodData>> fetch(
    PeriodLoadQuery query,
    RefreshMode refreshMode,
  ) =>
      ref.read(loadCyclePeriodUseCaseProvider)(query, refreshMode: refreshMode);

  @override
  CycleMetricState onLoadSuccess(
    CycleMetricState state,
    CyclePeriodData value,
    PeriodLoadQuery query,
  ) =>
      state.copyWith(
        isLoading: false,
  ...
  @override
  CycleMetricState onLoadError(CycleMetricState state, ScreenError error) =>
