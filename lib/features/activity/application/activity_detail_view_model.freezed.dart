...
mixin _$ActivityDetailState {
 ...
 bool get isLoading; ScreenError? get error; ExerciseData? get workout; List<HeartRateSample> get heartRateSamples; List<SpeedSample> get speedSamples; List<ActivityCadenceSample> get cadenceSamples; ActivitySplits get splits; HeartRateRecoveryReading get heartRateRecovery; ActivityDetailDisplay? get display;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ActivityDetailState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.error, error) || other.error == error)&&(identical(other.workout, workout) || other.workout == workout)&&const DeepCollectionEquality().equals(other.heartRateSamples, heartRateSamples)&&const DeepCollectionEquality().equals(other.speedSamples, speedSamples)&&const DeepCollectionEquality().equals(other.cadenceSamples, cadenceSamples)&&(identical(other.splits, splits) || other.splits == splits)&&(identical(other.heartRateRecovery, heartRateRecovery) || other.heartRateRecovery == heartRateRecovery)&&(identical(other.display, display) || other.display == display));
}


@override
int get hashCode => Object.hash(runtimeType,isLoading,error,workout,const DeepCollectionEquality().hash(heartRateSamples),const DeepCollectionEquality().hash(speedSamples),const DeepCollectionEquality().hash(cadenceSamples),splits,heartRateRecovery,display);

@override
String toString() {
  return 'ActivityDetailState(isLoading: $isLoading, error: $error, workout: $workout, heartRateSamples: $heartRateSamples, speedSamples: $speedSamples, cadenceSamples: $cadenceSamples, splits: $splits, heartRateRecovery: $heartRateRecovery, display: $display)';
}
...
@useResult
$Res call({
 bool isLoading, ScreenError? error, ExerciseData? workout, List<HeartRateSample> heartRateSamples, List<SpeedSample> speedSamples, List<ActivityCadenceSample> cadenceSamples, ActivitySplits splits, HeartRateRecoveryReading heartRateRecovery, ActivityDetailDisplay? display
});


$ExerciseDataCopyWith<$Res>? get workout;$HeartRateRecoveryReadingCopyWith<$Res> get heartRateRecovery;$ActivityDetailDisplayCopyWith<$Res>? get display;
...
/// Create a copy of ActivityDetailState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoading = null,Object? error = freezed,Object? workout = freezed,Object? heartRateSamples = null,Object? speedSamples = null,Object? cadenceSamples = null,Object? splits = null,Object? heartRateRecovery = null,Object? display = freezed,}) {
...
as ActivitySplits,heartRateRecovery: null == heartRateRecovery ? _self.heartRateRecovery : heartRateRecovery // ignore: cast_nullable_to_non_nullable
as HeartRateRecoveryReading,display: freezed == display ? _self.display : display // ignore: cast_nullable_to_non_nullable
as ActivityDetailDisplay?,
  ));
}
/// Create a copy of ActivityDetailState
/// with the given fields replaced by the non-null parameter values.
...
@override
@pragma('vm:prefer-inline')
$HeartRateRecoveryReadingCopyWith<$Res> get heartRateRecovery {
  
  return $HeartRateRecoveryReadingCopyWith<$Res>(_self.heartRateRecovery, (value) {
    return _then(_self.copyWith(heartRateRecovery: value));
  });
}/// Create a copy of ActivityDetailState
/// with the given fields replaced by the non-null parameter values.
@override
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  ScreenError? error,  ExerciseData? workout,  List<HeartRateSample> heartRateSamples,  List<SpeedSample> speedSamples,  List<ActivityCadenceSample> cadenceSamples,  ActivitySplits splits,  HeartRateRecoveryReading heartRateRecovery,  ActivityDetailDisplay? display)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ActivityDetailState() when $default != null:
return $default(_that.isLoading,_that.error,_that.workout,_that.heartRateSamples,_that.speedSamples,_that.cadenceSamples,_that.splits,_that.heartRateRecovery,_that.display);case _:
  return orElse();
...
@override@JsonKey() final  HeartRateRecoveryReading heartRateRecovery;
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,error,workout,const DeepCollectionEquality().hash(_heartRateSamples),const DeepCollectionEquality().hash(_speedSamples),const DeepCollectionEquality().hash(_cadenceSamples),splits,heartRateRecovery,display);
...
@override $ExerciseDataCopyWith<$Res>? get workout;@override $HeartRateRecoveryReadingCopyWith<$Res> get heartRateRecovery;@override $ActivityDetailDisplayCopyWith<$Res>? get display;
...
/// Create a copy of ActivityDetailState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isLoading = null,Object? error = freezed,Object? workout = freezed,Object? heartRateSamples = null,Object? speedSamples = null,Object? cadenceSamples = null,Object? splits = null,Object? heartRateRecovery = null,Object? display = freezed,}) {
