...
class ActivityMetricViewModel extends Notifier<ActivityMetricState>
    with PeriodMetricLoader<ActivityMetricState, ActivityPeriodData> {
  ...
  @override
  PeriodSelection selectionOf(ActivityMetricState state) =>
      PeriodSelection(state.selectedRange, state.selectedDate);

  @override
  ActivityMetricState onLoadStart(
  ...
  @override
  Future<Result<ActivityPeriodData>> fetch(
  ...
  @override
  ActivityMetricState onLoadSuccess(
    ActivityMetricState state,
    ActivityPeriodData value,
    PeriodLoadQuery query,
  ) =>
      state.copyWith(
        isLoading: false,
  ...
  @override
  ActivityMetricState onLoadError(
    ActivityMetricState state,
    ScreenError error,
  ) =>
