...
class BodyMetricViewModel extends Notifier<BodyMetricState>
    with PeriodMetricLoader<BodyMetricState, BodyPeriodData> {
  @override
  ...
  @override
  PeriodSelection selectionOf(BodyMetricState state) =>
      PeriodSelection(state.selectedRange, state.selectedDate);

  @override
  BodyMetricState onLoadStart(
  ...
  @override
  Future<Result<BodyPeriodData>> fetch(
    PeriodLoadQuery query,
    RefreshMode refreshMode,
  ) =>
      ref.read(loadBodyPeriodUseCaseProvider)(query, refreshMode: refreshMode);

  @override
  BodyMetricState onLoadSuccess(
    BodyMetricState state,
    BodyPeriodData value,
    PeriodLoadQuery query,
  ) =>
      state.copyWith(
        isLoading: false,
  ...
  @override
  BodyMetricState onLoadError(BodyMetricState state, ScreenError error) =>
