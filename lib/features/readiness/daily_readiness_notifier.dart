...
part 'daily_readiness_notifier.freezed.dart';
...
class DailyReadinessNotifier extends Notifier<DailyReadinessState> {
  int _generation = 0;
...
final dailyReadinessNotifierProvider =
    NotifierProvider<DailyReadinessNotifier, DailyReadinessState>(
  DailyReadinessNotifier.new,
);
