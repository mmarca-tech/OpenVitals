...
mixin _$HydrationEntryState {
 ...
 bool get isCheckingPermission; Set<String> get hydrationWritePermissions; Set<String> get nutritionWritePermissions; bool get canWriteHydration; bool get canWriteNutrition; double get todayHydrationLiters; double get dailyGoalLiters; CommandState<void> get save; List<HydrationContainerOption> get containerOptions; HydrationContainerOption get selectedContainer; double? get lastCustomAmountMilliliters; List<CustomHydrationDrink> get customDrinkOptions;/// The most-logged saved drinks, derived from Health Connect entries.
 List<CustomHydrationDrink> get frequentDrinkOptions; String? get editRecordId; DateTime? get editTime; HydrationEntryNotice? get entryNotice; HydrationEntryError? get entryError;/// The edit prefill could not be read — a different thing from a save that
...
@useResult
$Res call({
 bool isCheckingPermission, Set<String> hydrationWritePermissions, Set<String> nutritionWritePermissions, bool canWriteHydration, bool canWriteNutrition, double todayHydrationLiters, double dailyGoalLiters, CommandState<void> save, List<HydrationContainerOption> containerOptions, HydrationContainerOption selectedContainer, double? lastCustomAmountMilliliters, List<CustomHydrationDrink> customDrinkOptions, List<CustomHydrationDrink> frequentDrinkOptions, String? editRecordId, DateTime? editTime, HydrationEntryNotice? entryNotice, HydrationEntryError? entryError, ScreenError? prefillError
});


$CommandStateCopyWith<void, $Res> get save;$HydrationContainerOptionCopyWith<$Res> get selectedContainer;
...
/// Create a copy of HydrationEntryState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isCheckingPermission = null,Object? hydrationWritePermissions = null,Object? nutritionWritePermissions = null,Object? canWriteHydration = null,Object? canWriteNutrition = null,Object? todayHydrationLiters = null,Object? dailyGoalLiters = null,Object? save = null,Object? containerOptions = null,Object? selectedContainer = null,Object? lastCustomAmountMilliliters = freezed,Object? customDrinkOptions = null,Object? frequentDrinkOptions = null,Object? editRecordId = freezed,Object? editTime = freezed,Object? entryNotice = freezed,Object? entryError = freezed,Object? prefillError = freezed,}) {
  return _then(_self.copyWith(
...
as double,save: null == save ? _self.save : save // ignore: cast_nullable_to_non_nullable
as CommandState<void>,containerOptions: null == containerOptions ? _self.containerOptions : containerOptions // ignore: cast_nullable_to_non_nullable
...
as DateTime?,entryNotice: freezed == entryNotice ? _self.entryNotice : entryNotice // ignore: cast_nullable_to_non_nullable
as HydrationEntryNotice?,entryError: freezed == entryError ? _self.entryError : entryError // ignore: cast_nullable_to_non_nullable
as HydrationEntryError?,prefillError: freezed == prefillError ? _self.prefillError : prefillError // ignore: cast_nullable_to_non_nullable
as ScreenError?,
  ));
}
/// Create a copy of HydrationEntryState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isCheckingPermission,  Set<String> hydrationWritePermissions,  Set<String> nutritionWritePermissions,  bool canWriteHydration,  bool canWriteNutrition,  double todayHydrationLiters,  double dailyGoalLiters,  CommandState<void> save,  List<HydrationContainerOption> containerOptions,  HydrationContainerOption selectedContainer,  double? lastCustomAmountMilliliters,  List<CustomHydrationDrink> customDrinkOptions,  List<CustomHydrationDrink> frequentDrinkOptions,  String? editRecordId,  DateTime? editTime,  HydrationEntryNotice? entryNotice,  HydrationEntryError? entryError,  ScreenError? prefillError)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HydrationEntryState() when $default != null:
return $default(_that.isCheckingPermission,_that.hydrationWritePermissions,_that.nutritionWritePermissions,_that.canWriteHydration,_that.canWriteNutrition,_that.todayHydrationLiters,_that.dailyGoalLiters,_that.save,_that.containerOptions,_that.selectedContainer,_that.lastCustomAmountMilliliters,_that.customDrinkOptions,_that.frequentDrinkOptions,_that.editRecordId,_that.editTime,_that.entryNotice,_that.entryError,_that.prefillError);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isCheckingPermission,  Set<String> hydrationWritePermissions,  Set<String> nutritionWritePermissions,  bool canWriteHydration,  bool canWriteNutrition,  double todayHydrationLiters,  double dailyGoalLiters,  CommandState<void> save,  List<HydrationContainerOption> containerOptions,  HydrationContainerOption selectedContainer,  double? lastCustomAmountMilliliters,  List<CustomHydrationDrink> customDrinkOptions,  List<CustomHydrationDrink> frequentDrinkOptions,  String? editRecordId,  DateTime? editTime,  HydrationEntryNotice? entryNotice,  HydrationEntryError? entryError,  ScreenError? prefillError)  $default,) {final _that = this;
switch (_that) {
case _HydrationEntryState():
return $default(_that.isCheckingPermission,_that.hydrationWritePermissions,_that.nutritionWritePermissions,_that.canWriteHydration,_that.canWriteNutrition,_that.todayHydrationLiters,_that.dailyGoalLiters,_that.save,_that.containerOptions,_that.selectedContainer,_that.lastCustomAmountMilliliters,_that.customDrinkOptions,_that.frequentDrinkOptions,_that.editRecordId,_that.editTime,_that.entryNotice,_that.entryError,_that.prefillError);case _:
  throw StateError('Unexpected subclass');
...
class _HydrationEntryState extends HydrationEntryState {
  const _HydrationEntryState({this.isCheckingPermission = true, final  Set<String> hydrationWritePermissions = const <String>{}, final  Set<String> nutritionWritePermissions = const <String>{}, this.canWriteHydration = false, this.canWriteNutrition = false, this.todayHydrationLiters = 0.0, this.dailyGoalLiters = 2.0, this.save = const CommandState<void>.idle(), final  List<HydrationContainerOption> containerOptions = kDefaultHydrationContainers, required this.selectedContainer, this.lastCustomAmountMilliliters, final  List<CustomHydrationDrink> customDrinkOptions = const <CustomHydrationDrink>[], final  List<CustomHydrationDrink> frequentDrinkOptions = const <CustomHydrationDrink>[], this.editRecordId, this.editTime, this.entryNotice, this.entryError, this.prefillError}): _hydrationWritePermissions = hydrationWritePermissions,_nutritionWritePermissions = nutritionWritePermissions,_containerOptions = containerOptions,_customDrinkOptions = customDrinkOptions,_frequentDrinkOptions = frequentDrinkOptions,super._();
...
@override $CommandStateCopyWith<void, $Res> get save;@override $HydrationContainerOptionCopyWith<$Res> get selectedContainer;
...
as double,dailyGoalLiters: null == dailyGoalLiters ? _self.dailyGoalLiters : dailyGoalLiters // ignore: cast_nullable_to_non_nullable
as double,save: null == save ? _self.save : save // ignore: cast_nullable_to_non_nullable
as CommandState<void>,containerOptions: null == containerOptions ? _self._containerOptions : containerOptions // ignore: cast_nullable_to_non_nullable
as List<HydrationContainerOption>,selectedContainer: null == selectedContainer ? _self.selectedContainer : selectedContainer // ignore: cast_nullable_to_non_nullable
as HydrationContainerOption,lastCustomAmountMilliliters: freezed == lastCustomAmountMilliliters ? _self.lastCustomAmountMilliliters : lastCustomAmountMilliliters // ignore: cast_nullable_to_non_nullable
