...
part 'hydration_entry_view_model.freezed.dart';
...
class HydrationEntryViewModel extends Notifier<HydrationEntryState> {
  HydrationEntryViewModel({this.editRecordId});
