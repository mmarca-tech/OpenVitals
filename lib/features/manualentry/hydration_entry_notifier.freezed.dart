...
part of 'hydration_entry_notifier.dart';
...
@useResult
$Res call({
 bool isCheckingPermission, Set<String> hydrationWritePermissions, Set<String> nutritionWritePermissions, bool canWriteHydration, bool canWriteNutrition, double todayHydrationLiters, double dailyGoalLiters, bool isSavingEntry, List<HydrationContainerOption> containerOptions, HydrationContainerOption selectedContainer, double? lastCustomAmountMilliliters, List<CustomHydrationDrink> customDrinkOptions, String? editRecordId, DateTime? editTime, bool saveCompleted, HydrationEntryNotice? entryNotice, HydrationEntryError? entryError, ScreenError? writeError
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isCheckingPermission,  Set<String> hydrationWritePermissions,  Set<String> nutritionWritePermissions,  bool canWriteHydration,  bool canWriteNutrition,  double todayHydrationLiters,  double dailyGoalLiters,  bool isSavingEntry,  List<HydrationContainerOption> containerOptions,  HydrationContainerOption selectedContainer,  double? lastCustomAmountMilliliters,  List<CustomHydrationDrink> customDrinkOptions,  String? editRecordId,  DateTime? editTime,  bool saveCompleted,  HydrationEntryNotice? entryNotice,  HydrationEntryError? entryError,  ScreenError? writeError)  $default,) {final _that = this;
switch (_that) {
case _HydrationEntryState():
return $default(_that.isCheckingPermission,_that.hydrationWritePermissions,_that.nutritionWritePermissions,_that.canWriteHydration,_that.canWriteNutrition,_that.todayHydrationLiters,_that.dailyGoalLiters,_that.isSavingEntry,_that.containerOptions,_that.selectedContainer,_that.lastCustomAmountMilliliters,_that.customDrinkOptions,_that.editRecordId,_that.editTime,_that.saveCompleted,_that.entryNotice,_that.entryError,_that.writeError);case _:
  throw StateError('Unexpected subclass');
...
@override
int get hashCode => Object.hash(runtimeType,isCheckingPermission,const DeepCollectionEquality().hash(_hydrationWritePermissions),const DeepCollectionEquality().hash(_nutritionWritePermissions),canWriteHydration,canWriteNutrition,todayHydrationLiters,dailyGoalLiters,isSavingEntry,const DeepCollectionEquality().hash(_containerOptions),selectedContainer,lastCustomAmountMilliliters,const DeepCollectionEquality().hash(_customDrinkOptions),editRecordId,editTime,saveCompleted,entryNotice,entryError,writeError);
