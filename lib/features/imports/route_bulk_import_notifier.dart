...
class RouteBulkImportNotifier extends Notifier<RouteBulkImportState> {
  @override
...
final routeBulkImportProvider =
    NotifierProvider<RouteBulkImportNotifier, RouteBulkImportState>(
  RouteBulkImportNotifier.new,
);
