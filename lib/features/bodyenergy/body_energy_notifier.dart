...
part 'body_energy_notifier.freezed.dart';
...
class BodyEnergyNotifier extends Notifier<BodyEnergyState> {
  int _generation = 0;
...
final bodyEnergyNotifierProvider =
    NotifierProvider<BodyEnergyNotifier, BodyEnergyState>(
  BodyEnergyNotifier.new,
);
