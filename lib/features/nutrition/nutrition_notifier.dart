...
part 'nutrition_notifier.freezed.dart';
...
final Map<NutritionMetric, NotifierProvider<NutritionNotifier, NutritionState>>
    _nutritionMetricProviders = {
  for (final metric in NutritionMetric.values)
    metric: NotifierProvider<NutritionNotifier, NutritionState>(
      () => NutritionNotifier(metric),
    ),
};

/// The state provider for [metric]'s period detail screen.
NotifierProvider<NutritionNotifier, NutritionState> nutritionMetricProvider(
