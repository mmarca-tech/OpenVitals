...
as bool,coMapsNavigationContextEnabled: null == coMapsNavigationContextEnabled ? _self.coMapsNavigationContextEnabled : coMapsNavigationContextEnabled // ignore: cast_nullable_to_non_nullable
as bool,saveCoMapsNavigationContext: null == saveCoMapsNavigationContext ? _self.saveCoMapsNavigationContext : saveCoMapsNavigationContext // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
/// Off by default: it is an integration with another app, and it asks for a
/// permission, so it is the user's to switch on.
@override@JsonKey() final  bool coMapsNavigationContextEnabled;
/// Keep the sampled guidance in the activity's history. Meaningless without
/// [coMapsNavigationContextEnabled], and gated on it in the UI. Never
/// exported to Health Connect.
@override@JsonKey() final  bool saveCoMapsNavigationContext;
