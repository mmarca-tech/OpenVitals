...
public class GeolocationManager
  ...
  public LocationClient createLocationClient(
    ...
    // This fork has no Google Play Services. Upstream would pick the fused
    // provider when GMS is present; OpenVitals always passes
    // forceLocationManager anyway (it wants satellite fixes, not fused
    // network/wifi ones), so the fused branch was already dead code.
