...
/**
 * Ported from the native OpenVitals app (`healthconnect/HealthConnectPaging.kt`).
 *
 * Pages through [readRecords] honoring [ascendingOrder], [pageSize] and an
 * optional [maxRecords] cap. The [maxRecords] cap is the durable fix for the
 * unbounded-read ANR: callers reading "latest" pass `maxRecords = 1`, and
 * high-frequency series cap their windows instead of loading every page.
 */
