...
- Elevation correction for imported routes from SRTM elevation tiles stored on the phone, so a drifting barometer no longer inflates altitude and gain; phone recordings are left alone
