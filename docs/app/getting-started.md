...
Settings includes Data Importers for supported Apple Health `export.xml` or `export.zip` records, GPX/KML/KMZ route files, and FIT activity/course/workout files.
