...
OpenVitals can import GPX, KML, and KMZ route files from Settings, Data Importers, preview the result in Activity Entry, and save supported activities to Health Connect.
