...
- [Development](development.md): local build, verification, CI, release, and Windows cleanup notes.
...
- [Review archive](reviews/): historical review reports and checklists.
