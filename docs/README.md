...
- [Manual activity entry plan](manual-activity-entry-plan.md): implementation status for activity logging, GPX/KML/KMZ/FIT import, and live GPS recording.
...
- [Release notes](releases/1.3.0.md): Codeberg-facing release notes for the current release.
