...
final samples = <ImportRecord>[
  ...
  TotalCaloriesBurnedImportRecord(
    clientRecordId: 'x',
    startTime: utc(2026, 1, 10),
    startZoneOffset: null,
    endTime: utc(2026, 1, 10, 23, 59),
    endZoneOffset: null,
    kilocalories: 2200,
  ),
  PowerImportRecord(
    clientRecordId: 'x',
    startTime: utc(2026, 1, 11, 6),
    startZoneOffset: null,
    endTime: utc(2026, 1, 11, 7),
    endZoneOffset: null,
    samples: [PowerSampleValue(utc(2026, 1, 11, 6), 210), PowerSampleValue(utc(2026, 1, 11, 6, 30), 195)],
  ),
  StepsCadenceImportRecord(
    clientRecordId: 'x',
    startTime: utc(2026, 1, 12, 6),
    startZoneOffset: null,
    endTime: utc(2026, 1, 12, 7),
    endZoneOffset: null,
    samples: [StepsCadenceSampleValue(utc(2026, 1, 12, 6), 165.5)],
  ),
  CyclingPedalingCadenceImportRecord(
    clientRecordId: 'x',
    startTime: utc(2026, 1, 13, 6),
    startZoneOffset: null,
    endTime: utc(2026, 1, 13, 7),
    endZoneOffset: null,
    samples: [CyclingPedalingCadenceSampleValue(utc(2026, 1, 13, 6), 90)],
  ),
  SkinTemperatureImportRecord(
    clientRecordId: 'x',
    startTime: utc(2026, 1, 14, 2),
    startZoneOffset: null,
    endTime: utc(2026, 1, 14, 7),
    endZoneOffset: null,
    baselineCelsius: 33.4,
    measurementLocation: 1,
    deltas: [SkinTemperatureDeltaValue(utc(2026, 1, 14, 2), 0.2), SkinTemperatureDeltaValue(utc(2026, 1, 14, 3), -0.1)],
  ),
  MenstruationPeriodImportRecord(
    clientRecordId: 'x',
    startTime: utc(2026, 1, 15),
    startZoneOffset: null,
